// Component tests for usa-character-count
import './index.ts';
import {
  testRapidClicking,
...
describe('CharacterCount Component Tests', () => {
  beforeEach(() => {
  ...
  it('should render component with default properties', () => {
    cy.mount('<usa-character-count></usa-character-count>');
    cy.get('usa-character-count').should('exist');
    cy.get('usa-character-count').should('be.visible');
  });
  ...
  it('should handle rapid clicking without visual glitches', () => {
    ...
    cy.get('usa-character-count').as('component');
  ...
  it('should handle interaction during CSS transitions', () => {
    ...
    cy.get('usa-character-count').click().click(); // Immediate second click
  ...
  it('should maintain accessibility after rapid interactions', () => {
    ...
    cy.get('usa-character-count').click().focus().blur().click().click();

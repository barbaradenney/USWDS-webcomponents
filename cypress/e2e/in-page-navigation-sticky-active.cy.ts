  ...
  describe('Sticky Navigation Positioning', () => {
    ...
    it('should remain in fixed position during page scroll', () => {
      ...
      cy.get('usa-in-page-navigation').then(($nav) => {
        ...
        cy.scrollTo(0, 500);
      cy.wait(500); // Wait for intersection observer        cy.wait(750);
    ...
    it('should remain visible throughout entire page scroll', () => {
      ...
      cy.wait(500); // Wait for intersection observer        cy.wait(400);
    ...
    it('should handle rapid scrolling without position glitches', () => {
      ...
      cy.wait(500); // Wait for intersection observer      cy.scrollTo(0, 1000, { duration: 100 });
      cy.wait(500); // Wait for intersection observer      cy.scrollTo(0, 200, { duration: 100 });
      cy.wait(500); // Wait for intersection observer      cy.scrollTo(0, 1500, { duration: 100 });
      cy.wait(500); // Wait for intersection observer

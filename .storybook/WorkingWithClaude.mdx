...
- ✅ **100% USWDS Compliance** - Achieved through systematic validation
- ✅ **Zero Breaking Changes** - Careful architectural decisions
- ✅ **Comprehensive Testing** - Every component fully tested
- ✅ **Complete Documentation** - No component left undocumented
- ✅ **Automated Quality** - 13 pre-commit validation stages
...
✅ "The button component's hover state isn't working in Safari. The expected behavior is [X] but actual is [Y]. Please debug following USWDS_JAVASCRIPT_DEBUGGING_PROTOCOL.md"

### 2. Reference Documentation
❌ "Make it follow our patterns"
✅ "Implement following the Script Tag Pattern described in CLAUDE.md and USWDS_INTEGRATION_GUIDE.md section 2.1"

### 3. Provide Context
❌ "Tests are failing"
✅ "Tests are failing with error: [paste error]. This started after [change]. The component uses [USWDS pattern]. Reference: [file:line]"

### 4. Request Validation
❌ "Is this done?"
✅ "Please verify this implementation: 1) All tests pass, 2) USWDS compliant, 3) Documentation updated, 4) Storybook working, 5) Pre-commit hooks pass"

### 5. Ask for Explanations
❌ "Why doesn't this work?"
✅ "Explain why the Script Tag Pattern is required for this component and what would happen if we used ES module imports instead"

### 6. Request Step-by-Step Approaches
❌ "Build feature X"
✅ "Build feature X following this workflow: 1) Design, 2) Implement, 3) Test, 4) Document, 5) Validate. Let's start with step 1 design"

...
**Triggers:**
- Component files changed → Update CHANGELOGs and READMEs
- Test files changed → Update TESTING.md
- Documentation changed → Update Storybook docs (currently disabled)
...
Before:
docs/
├── BUTTON_INVESTIGATION_2025_10_01.md (temp, 8 days old)
├── TEST_FAILURE_ANALYSIS_2025_09_15.md (status, 35 days old)
└── ARCHITECTURE_PATTERNS.md (permanent)
...
└── archive/
    └── 2025-10/
        ├── BUTTON_INVESTIGATION_2025_10_01.md
        └── TEST_FAILURE_ANALYSIS_2025_09_15.md
```
...
**Output:**
```
🤖 Running AI code quality validation (informational)...

⚠️  AI Code Quality Issues Found (non-blocking)

💡 These issues don't block your commit but should be addressed:
   • Remove console.log statements
   • Clean up debugging code
   • Add cleanup to event listeners/timers
...
# ✅ AI quality validation (informational)
# ✅ ESLint auto-fix
# ✅ Prettier formatting
# ✅ Cache cleanup
...
# def456 - docs: update component changelogs 🤖
# ghi789 - chore: automated code cleanup 🤖
```
...
**Post-Commit Actions:**
```
🔄 Post-commit: Updating component changelogs for 1 component file changes...
📝 Changelogs updated
📖 Post-commit: Updating component README files for 1 component file changes...
📖 README files updated
📝 Staging documentation changes...
✅ Component documentation updated and committed
...
**Post-Commit Actions:**
```
📋 Post-commit: Updating testing documentation for 1 test file changes...
...
**Post-Commit Actions:**
```
🚨 Detected --no-verify commit
📋 Generating discovered issues tracker...

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
⚠️  IMPORTANT: Fix discovered issues before starting new work
...
**Post-Commit Actions:**
```
🔄 Post-commit: Updating component changelogs...
✅ Component documentation updated and committed
...
# ✅ All 13 validation stages pass
# ✅ Commit allowed

# POST-COMMIT runs:
# 🔄 Detects: 1 component file changed
# 📝 Updates: src/components/button/CHANGELOG.md
# 📖 Updates: src/components/button/README.md
# ✅ Creates automatic commit:
#    "docs: update component changelogs and READMEs"

# 3. Git history now shows:
# abc123 - feat(button): add danger variant
# def456 - docs: update component changelogs and READMEs 🤖
...
git commit -m "new feature"            # ❌ BLOCKED!

# Good workflow (enforced):
git commit --no-verify -m "quick fix"  # Issues discovered
git commit -m "fix: resolve issues"    # ✅ Must fix first
git commit -m "new feature"            # ✅ Now allowed
```

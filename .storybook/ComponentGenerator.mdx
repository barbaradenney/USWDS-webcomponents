...
```bash
npm run generate:component -- --name=alert-box

🎯 Generating USWDS-compliant component: alert-box
📁 Directory: src/components/alert-box

✅ Created: src/components/alert-box/usa-alert-box.ts
✅ Created: src/components/alert-box/usa-alert-box.test.ts
✅ Created: src/components/alert-box/usa-alert-box.stories.ts
✅ Created: src/components/alert-box/README.mdx
✅ Created: src/components/alert-box/CHANGELOG.mdx
✅ Created: src/components/alert-box/TESTING.md
✅ Created: src/components/alert-box/index.ts

🎉 Component generated successfully!

📋 Next steps:
   1. Review generated files in src/components/alert-box/
   ...
   5. Run: npm test src/components/alert-box
```

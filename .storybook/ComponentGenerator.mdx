...
```bash
pnpm run generate:component -- --name=alert-box

🎯 Generating USWDS-compliant component: alert-box
📦 Select package: @uswds-wc/feedback
📁 Directory: packages/uswds-wc-feedback/src/components/alert-box

✅ Created: packages/uswds-wc-feedback/src/components/alert-box/usa-alert-box.ts
✅ Created: packages/uswds-wc-feedback/src/components/alert-box/usa-alert-box.test.ts
✅ Created: packages/uswds-wc-feedback/src/components/alert-box/usa-alert-box.stories.ts
✅ Created: packages/uswds-wc-feedback/src/components/alert-box/README.mdx
✅ Created: packages/uswds-wc-feedback/src/components/alert-box/CHANGELOG.mdx
✅ Created: packages/uswds-wc-feedback/src/components/alert-box/TESTING.md
✅ Created: packages/uswds-wc-feedback/src/components/alert-box/index.ts
...
- ✅ Lit Element with decorators
- ✅ USWDS CSS import
- ✅ Light DOM (no Shadow DOM)
- ✅ Proper USWDS initialization
- ✅ Web component managed flag
- ✅ JSDoc comments with USWDS references
...
- ✅ Event emission tests (for interactive components)
...
- ✅ Default story
- ✅ Variant stories (for common variants)
...
npm run generate:component -- --name=my-component --category=Forms --interactive=true
```
...
### 1. USWDS Compliance
```typescript
// ✅ Generated components use official USWDS CSS
import '../../styles/styles.css';

// ✅ Official USWDS classes
<div class="usa-alert-box">
```
...
// ❌ Avoided: Untyped properties
@property() variant; // Generator never creates this
```

### 3. Accessibility Baseline
```typescript
// ✅ ARIA attributes included in templates
...
```bash
npm run generate:component -- --name=text-area --category=Forms

# Generated structure:
src/components/text-area/
├── usa-text-area.ts          # Component implementation
├── usa-text-area.test.ts     # Unit tests
├── usa-text-area.stories.ts  # Storybook stories
├── README.mdx                 # API documentation
...
```bash
npm run generate:component -- --name=breadcrumb --category=Navigation
...
- ✅ CHANGELOG auto-updates on changes
- ✅ README auto-sync with properties
- ✅ TESTING.md updates with test changes

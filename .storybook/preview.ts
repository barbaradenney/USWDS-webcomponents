    ...
    options: {
      storySort: {
        order: [
          'Getting Started',
          'Documentation',
          ['About', 'USWDS Compliance', 'Bundle Optimization', 'CI/CD Pipeline', 'Pre-Commit System', 'Post-Commit System', 'Component Generator', 'USWDS Sync System', 'Weekly Automation', 'Working With Claude'],
          'Forms',
          'Navigation',
          'Data Display',
          'Feedback',

...
<Meta title="Bundle Optimization" />
...
```
Total Package: 18.1 MB (tree-shakeable)
Components: 45 USWDS components

dist/
├── index.js           2 KB  (1 KB gzipped)  - Entry point
├── Category bundles/
│   ├── forms/index.js          0 KB
│   ├── navigation/index.js     0 KB
│   ├── layout/index.js         0 KB
│   ├── feedback/index.js       0 KB
│   ├── actions/index.js        0 KB
│   ├── data-display/index.js   0 KB
│   ├── structure/index.js      0 KB
├── Component bundles  12 files (with content hashing)

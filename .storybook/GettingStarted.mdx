...
<html lang="en">
  ...
  <body>
    ...
    <script type="module">
      ...
      import { USAButton } from 'https://cdn.jsdelivr.net/npm/@uswds-wc/actions/+esm';
      import { USAAlert } from 'https://cdn.jsdelivr.net/npm/@uswds-wc/feedback/+esm';

      // Or import from meta package
      // import { USAButton, USAAlert } from 'https://cdn.jsdelivr.net/npm/@uswds-wc/+esm';
...
```javascript
// ✅ Category packages: ~120-180 KB for typical app
...
```javascript
// ⚠️ Meta package: ~475 KB (all components)
...
```javascript
// ✅ Individual components: ~50-80 KB
import { USAButton } from '@uswds-wc/actions/components/button';
import { USAAlert } from '@uswds-wc/feedback/components/alert';
import '@uswds-wc/core/styles.css';
```
